...
func nextView_(g *gocui.Gui, v *gocui.View) error {
...
func quit_(g *gocui.Gui, v *gocui.View) error {
	return gocui.ErrQuit
}

func keybindings(g *gocui.Gui) error {
	if err := g.SetKeybinding("side", gocui.KeyCtrlSpace, gocui.ModNone, nextView_); err != nil {
		return err
	}
	if err := g.SetKeybinding("main", gocui.KeyCtrlSpace, gocui.ModNone, nextView_); err != nil {
		return err
	}
	...
	if err := g.SetKeybinding("", gocui.KeyCtrlC, gocui.ModNone, quit_); err != nil {
		return err
	}
...
func layout_(g *gocui.Gui) error {
	maxX, maxY := g.Size()
